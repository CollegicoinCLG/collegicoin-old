...
unlocked to sign the Collegicoin-Qt.app bundle.
...
allowing somebody to distribute a Collegicoin-Qt.app or collegicoin-qt-setup.exe with a valid
...
that the collegicoin-qt.exe file inside the installer had not been tampered with.
