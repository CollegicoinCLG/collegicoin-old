...
- ThreadSocketHandler : Sends/Receives data from peers on port 12034.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 3386 for connections and services them.

- CollegicoinMiner : Generates coins (if wallet is enabled).
