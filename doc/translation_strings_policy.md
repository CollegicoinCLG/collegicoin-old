...
This document provides guidelines for internationalization of the Collegicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `collegicoin_en.ts` remains unchanged.
