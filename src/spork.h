...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 5000;         // 1000 CLG
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 1519862400;   // ON
