...
{
    // TODO: This is different from what we have in Collegicoin which only calls ConnectNode from OpenNetworkConnection
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        std::string strDesc = "Collegicoin Core " + FormatFullVersion();
