...
const char * const CLG_CONF_FILENAME = "collegicoin.conf";
const char * const CLG_PID_FILENAME = "collegicoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/CollegicoinCore";
#else
    // Unix
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", CLG_CONF_FILENAME));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty collegicoin.conf if it does not excist
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", CLG_PID_FILENAME));
