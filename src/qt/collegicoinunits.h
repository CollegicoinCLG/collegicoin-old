...
#ifndef CLG_QT_CLGUNITS_H
#define CLG_QT_CLGUNITS_H
...
/** Collegicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CollegicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CollegicoinUnits(QObject *parent);

    /** Collegicoin units.
      @note Source: https://en.collegicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CLG,
...
typedef CollegicoinUnits::Unit CollegicoinUnit;

#endif // CLG_QT_CLGUNITS_H
