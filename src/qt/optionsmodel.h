...
#ifndef CLG_QT_OPTIONSMODEL_H
#define CLG_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Collegicoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // CollegicoinUnits::Unit
