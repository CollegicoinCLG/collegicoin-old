...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCollegicoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CollegicoinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCollegicoinURI(info));
}
