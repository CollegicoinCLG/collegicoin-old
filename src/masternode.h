...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 50000CLG, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 50000 CLG - checking if valid masternode)
