...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CollegicoinNetwork") type = CollegicoinNetwork;
    if(strType == "CollegicoinNetworkVariable") type = CollegicoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CollegicoinNetwork) s = "CollegicoinNetwork";
    if(type == CollegicoinNetworkVariable) s = "CollegicoinNetworkVariable";
