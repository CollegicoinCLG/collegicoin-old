...
This document describes the protocol extensions for all additional functionality build into the Collegicoin protocol. This doesn't include any of the Collegicoin protocol, which has been left intact in the Collegicoin project. For more information about the core protocol, please see https://en.collegicoin.it/w/index.php?title#Protocol_documentation&action#edit
...
Collegicoin Outpoint https://collegicoin.org/en/glossary/outpoint
...
Collegicoin Input https://collegicoin.org/en/glossary/input
...
Collegicoin Output https://collegicoin.org/en/glossary/output
...
Collegicoin Public Key https://collegicoin.org/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 1000 CLG
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 1000 CLG unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 collegicoin)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the collegicoin treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 1000 CLG for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 1000 CLG for masternode 2
